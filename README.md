...
> 💡 No Linux, instale o `xclip` com `sudo apt install xclip` (ou o gerenciador equivalente) caso não esteja disponível. Em
> distribuições que usam `wl-copy`, basta substituir o comando final.
